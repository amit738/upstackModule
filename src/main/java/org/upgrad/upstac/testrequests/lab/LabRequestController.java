...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        User loggedInTester = userLoggedInService.getLoggedInUser(); //get the currently logged in tester
        return testRequestQueryService.findByTester(loggedInTester); //get all test requests assigned to the given tester
