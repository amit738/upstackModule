...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        return testRequestQueryService.findBy(RequestStatus.LAB_TEST_COMPLETED); // get all test requests for which lab test is completed
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        // replace this line of code with your implementation
        User loggedInDoctor = userLoggedInService.getLoggedInUser(); // get the current logged in doctor
        return testRequestQueryService.findByDoctor(loggedInDoctor); // get all test requests assigned to given doctor
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            User loggedInDoctor = userLoggedInService.getLoggedInUser(); // get the current logged in doctor
            return testRequestUpdateService.assignForConsultation(id,loggedInDoctor); // assign the given test request to the given doctor for consultation
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            User loggedInDoctor = userLoggedInService.getLoggedInUser(); // get the currently logged in doctor
            return testRequestUpdateService.updateConsultation(id,testResult,loggedInDoctor);// update the consultation details for given test request for the given doctor
